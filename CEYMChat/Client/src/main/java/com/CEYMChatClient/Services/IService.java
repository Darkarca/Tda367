...
public interface IService {
     ...
     *  the IService to the ServerSocket
     */
    void connectToS();

    /** Handles how the service sends a command
     * to the server letting it know a connection
     * has been made so the Server can identify the user
     */
    ...
    /** Handles how the service shuts off the connection
     * between the service and the Server safely
     */
    void stop();
